...
public class Editar_especie extends javax.swing.JDialog implements ActionListener{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Editar_especie.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Editar_especie dialog = new Editar_especie(new javax.swing.JFrame(), true);
